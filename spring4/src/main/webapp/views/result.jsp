...
<link href='../public/css/style.css' rel="stylesheet" type="text/css"></link>
<link href='../public/css/css/font-awesome.css' rel="stylesheet" type="text/css"></link>
...
<h2 class="page-title">Task Manager using AngularJS</h2>	
	<div id="task-panel" class="fadein fadeout showpanel panel"  ng-show="toggle">	
		...
		<div class="panel-body">
			<div class="task" ng-repeat="task in tasks | orderBy:orderProp">
